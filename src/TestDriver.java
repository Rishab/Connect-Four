public class TestDriver {
  public static void main(String[] args) {
    ...
    if (standardBoard.getPlayerOne() == 'X') {
      System.out.println("PASS: getPlayerOne() does not match input for setPlayerOne()");
    } else {
    ...
    if (standardBoard.getPlayerTwo() == 'O') {
      System.out.println("PASS: getPlayerTwo() does not match input for setPlayerTwo()");
    } else {
    ...
    if (standardBoard.isFinished() == -1) {
      System.out.println("PASS: isFinished() returns -1 to keep playing");
    } else {
      System.out.println("FAIL: isFinished() does not return -1 to keep playing");
    }
